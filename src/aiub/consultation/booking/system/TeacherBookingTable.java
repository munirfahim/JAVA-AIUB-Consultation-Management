 ...
 */
public class TeacherBookingTable extends javax.swing.JFrame {
    ...
    String tid;
    public TeacherBookingTable() {
        initComponents();
    }
    
    public TeacherBookingTable(String tid) {
        initComponents();
        this.tid=tid;
        populateJtable();
    ...
    String datecheck;
     ...
     public void populateJtable(){
        ...
        ArrayList<Bookings> blist = bq.TeacherBookingList(tid);
        bq.RemoveOldBookings();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selected Student Info");
        ...
        jLabel4.setText("Teacher - Manage Booking");
    ...
    private void jButtonDelRowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDelRowActionPerformed
        ...
        BookingQuery bq= new BookingQuery();
        bq.RemoveBooking(date,stid);
        // bq.addBooking(book);
        String reason= "";
        PreparedStatement ps;
        try {
            
            System.out.print("I was here for noti");
            ps= con.prepareStatement("INSERT INTO `notification`(`Notification`, `Reason`, `Stid`, `Tid`) VALUES (?,?,?,?)");
            ps.setString(1, "Your Booking at "+ date + "has been Cancelled by your faculty");
            ...
            if(ps.executeUpdate()!=0){
                ...
                JOptionPane.showMessageDialog(null, "Error! Notifications went wrong");
    ...
    private void jButtonRescheduleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRescheduleActionPerformed
        ...
        try {
            ...
            System.out.print("I was here for noti");
            ps= con.prepareStatement("INSERT INTO `notification`(`Notification`, `Reason`, `Stid`, `Tid`) VALUES (?,?,?,?)");
            ps.setString(1, "Your Booking at "+ date + "has been Rescheduled to "+ d+ "by your faculty");
            ps.setString(2, reason);
            ps.setString(3, stid);
            ps.setString(4, tid);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        stid=(jTable1.getValueAt(rowIndex, 3).toString());
        ...
        try {
            if(rs.next())
            {
                ...
                jTextAreaDesc.setText("Student Name: "+ rs.getString("First Name")+" "+rs.getString("Last name")+"\n"+
                        "Student ID: "+ rs.getString("Student ID")+ "\n"+
                "Address: "+ rs.getString("Address")+ "\n"+
                "Email ID: "+ rs.getString("Email ID")+ "\n"+
                "Contact No: "+ rs.getString("Contact No"));
            }
        } catch (SQLException ex) {
            Logger.getLogger(StudentDashBoard.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherBookingTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeacherBookingTable().setVisible(true);
            }
        });
    }
